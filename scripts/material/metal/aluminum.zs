...
val compress0=<jaopca:item_platedensealuminium>;
...
//val shield0=<basemetals:aluminum_shield>;
#Dict
...
recipes.addShapeless("aluminum_plate_sh",plate0,[<soviet:hammer>.anyDamage().transformDamage(1),ingot,ingot]);
